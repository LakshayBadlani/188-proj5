    ...
    def getBeliefDistribution(self):
        ...
        for p in self.particles:
            ...
            if p in p_counts:
                ...
                p_counts[p] = 1
        for p in self.particles:
            curr_beliefs[p] = float(p_counts[p])/float(total_p)
        return curr_beliefs
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = []
        "*** YOUR CODE HERE ***"
        all_particles = list(itertools.product(self.legalPositions, repeat=self.numGhosts))
        while len(self.particles) < self.numParticles:
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            """*** END YOUR CODE HERE ***"""
            newParticles.append(tuple(newParticleList))
